...
TEST_CASE("formula_refiners", "[]")
{
    ...
    CHECK(!has_flag(flags, flags_t::reduce_contacts_less_eq_with_constants));
    ...
    flags |= flags_t::remove_double_negation | flags_t::convert_disjunction_in_contact_less_eq | flags_t::convert_contact_less_eq_with_same_terms | flags_t::reduce_constants | flags_t::reduce_contacts_less_eq_with_constants;
    CHECK(flags == flags_t::all);
    CHECK(flags != flags_t::none);
    ...
    flags = flags_t::reduce_contacts_less_eq_with_constants;
