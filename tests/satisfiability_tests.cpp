...
void is_satisfiable(const char* input_f, bool has_satisfiable_model, bool has_satisfiable_connected_model,
...
{
    is_satisfiable("(C(a, b) | ~C(a, b)) & (C(a,b) | ~C(a,b))", true, true);
}

TEST_CASE("satisfiable 8", "[satisfiability]")
{
    is_satisfiable("(C(a, b) | ~C(a, b)) & (C(a,b) | ~C(a,c))", true, true);
}

TEST_CASE("satisfiable 9", "[satisfiability]")
{
    is_satisfiable("C(a, -b) & ~C(a, b + h)", true, true);
}

TEST_CASE("satisfiable 10", "[satisfiability]")
{
    is_satisfiable("C(a * c, (-b) + h) & ~C(a * c, (-b) + h)", false, false);
}

TEST_CASE("satisfiable 11", "[satisfiability]")
{
    is_satisfiable("(C(a, b) & (C(f, h) & C(j, k))) & ~((C(a, b) & C(f, h)) & C(j, k))", false, false, false);
}

TEST_CASE("satisfiable 12", "[satisfiability]")
{
    is_satisfiable("(C(a, b) & (C(f, h) & C(j, k))) & ~((C(a, b) & C(f, h)) & C(j, J))", true, true, false);
}

TEST_CASE("satisfiable 13", "[satisfiability]")
{
    is_satisfiable("<=(a,b) & <=(b,a)", true, true);
}
...
{
    is_satisfiable("<=(a,b) & ~(<=(a,b))", false, false);
}

TEST_CASE("satisfiable 16", "[satisfiability]")
{
    is_satisfiable("(<=(a,b) & (~(<=(b,a)))) | (<=(a,b))", true, true);
}

TEST_CASE("satisfiable 17", "[satisfiability]")
{
    is_satisfiable("(<=(a,b) & (~(<=(a,b)))) | (C(a,b) & (~C(a,b)))", false, false);
}

TEST_CASE("satisfiable 18", "[satisfiability]")
{
    is_satisfiable("(<=(a,b) & (~(<=(a,b)))) | (C(a,b) & (~C(b,b)))", false, false);
}

TEST_CASE("satisfiable 18.1", "[satisfiability]")
{
    is_satisfiable("(<=(a,b) & (~(<=(a,b)))) | (C(a,b) & (~C(-b,b)))", true, true);
}

TEST_CASE("satisfiable 18.2", "[satisfiability]")
{
    is_satisfiable("(C(a,b) & ~C(b,b)) | (C(a,b) & ~C(-b,b))", true, true);
}
...
{
    is_satisfiable("~C(x * -z,b) & (~C(-b,b) & ~<=(x, z))", true, true);
}

TEST_CASE("satisfiable evaluation of path 2", "[satisfiability]")
{
    is_satisfiable("~C(x * -z, (b * -k) + c) & (~C(-b,b) & (~<=(x, z) & ~<=(b, k)))", true, true, false);
}
...
{
    is_satisfiable("<=(a, c) & C(a * (-b), c)", true, true);
}

TEST_CASE("satisfiable with contact rule 3", "[satisfiability]")
{
    is_satisfiable("<=(a, c) & (C(a * (-c), d) & C(a * (-b), c))", false, false);
}

TEST_CASE("satisfiable with contact rule 4", "[satisfiability]")
{
    is_satisfiable("<=(a, c) & (C(a * (-c), d) | C(a * (-b), c))", true, true);
}

TEST_CASE("satisfiable with contact rule 5", "[satisfiability]")
{
    is_satisfiable("(<=(a, c) | <=(a,b)) & (C(a * (-c), d) | C(a * (-b), c))", true, true);
}

TEST_CASE("satisfiable with contact rule 6", "[satisfiability]")
{
    is_satisfiable("(<=(a, c) & <=(a,b)) & (C(a * (-c), d) | C(a * (-b), c))", false, false, false);
}
...
{
    is_satisfiable("(~<=(a,b) & (~<=(c,d) & C(a * -b, c * -d)))", true, true);
}
...
TEST_CASE("satisfiable with contact rule - adding zero terms after adding contact using same terms 1",
          "[satisfiability]")
{
    is_satisfiable("C(a * -d, b * -c) & ( (C(a * -d, d) & <=(a,d)) | <=(b,c))", false, false, false);
}

TEST_CASE("satisfiable with contact rule - adding zero terms after adding contact using same terms 2",
          "[satisfiability]")
{
    is_satisfiable("C(a * -d, b * -c) & ((C(a * -d, d) & <=(a,d)) | <=(b,x))", true, true, false);
}
