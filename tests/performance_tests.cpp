...
// TODO: this one fails, investigate if the formula has satisfiable model or we have a bug with the algorithms (most probably the formula has a satisfiable model)
