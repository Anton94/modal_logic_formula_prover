...
\begin{document}
	...
	\subsection{Modal points}
		Before we start with model building we need to define a modal point representation. With $n$ boolean variables we can uniquely identify $2^n$ objects. It is sufficient to define a modal point representation which satisfies it. For $n$ variables it should be able to give $2^n$ unique points.
		\begin{defn}
