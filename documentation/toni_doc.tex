...
\end{titlepage}
	...
	\par
	Here is the tableau expansion beginning with the signed formula

	$\SF~(X~\land~Y) \Rightarrow \neg(\neg X \land \neg Y)$.

	\begin{center}
	\begin{forest}
		[$\{ \SF (X \land Y) \Rightarrow \neg(\neg X \land \neg Y) \}$
			[$\{ \ST X \land Y$ \mbox{, } $\SF \neg(\neg X \lor \neg Y)\}$
				[$\{ \ST X$ \mbox{, } $\ST Y$ \mbox{, } $\SF \neg(\neg X \lor \neg Y)\}$
					[$\{ \ST X$ \mbox{, } $\ST Y$ \mbox{, } $\ST \neg X \lor \neg Y\}$
						[$\{ \ST X$ \mbox{, } $\ST Y$ \mbox{, } $\ST \neg X\}$
							[$\{ \ST X$ \mbox{, } $\ST Y$ \mbox{, } $\SF X\}$]
						]
						[$\{ \ST X$ \mbox{, } $\ST Y$ \mbox{, } $\ST \neg Y\}$
							[$\{ \ST X$ \mbox{, } $\ST Y$ \mbox{, } $\SF Y\}$]
						]
					]
				]
			]
	...
	\begin{center}
	\begin{forest}
		[$\{ \SF ((X \Rightarrow Y) \Rightarrow ((Y \Rightarrow X) \Rightarrow \neg Y)) \}$
			[$\{ \ST X \Rightarrow Y$ \mbox{, } $\SF ((Y \Rightarrow X) \Rightarrow \neg Y) \}$
				[$\{ \ST X \Rightarrow Y$ \mbox{, } $\ST Y \Rightarrow X$ \mbox{, } $\SF \neg Y \}$
					[$\{ \ST X \Rightarrow Y$ \mbox{, } $\ST Y \Rightarrow X$ \mbox{, } $\ST Y \}$
						[$\{ \SF X$ \mbox{, } $\ST Y \Rightarrow X$ \mbox{, } $\ST Y \}$
							[$\{ \SF X$ \mbox{, } $\SF Y$ \mbox{, } $\ST Y \}$]
							[$\{ \SF X$ \mbox{, } $\ST X$ \mbox{, } $\ST Y \}$]
						]
						[$\{ \ST Y$ \mbox{, } $\ST Y \Rightarrow X \}$
							[$\{ \ST Y$ \mbox{, } $\SF Y \}$]
							[$\{ \ST Y$ \mbox{, } $\ST X \}$]
						]
					]
