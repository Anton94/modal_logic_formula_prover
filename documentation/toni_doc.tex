...
\begin{titlepage}
	...
	{\huge\bfseries{\textsc{Satisfiability of Connected Contact Logics}}}
...
\\
	...
	The user application is a Web page. The Web server is implemented with the third-party CppRestSDK \cite{cpprestsdk} library. The satisfiability checking runs on the server. There is a feature to interrupt an ongoing process. Can be triggered by the user via a button. There is a user disconnecting detection which cancels the requested formula prooving.
