...
\\
	...
	\begin{lemma}
		...
		\begin{itemize}
			\item G preserves the satisfiability of the contacts in $\beta$ if
			\begin{gather*}
				C(a,b) \in \beta \rightarrow (\exists x \in \upsilon_n(a) \cap W)(\exists y \in \upsilon_n(b) \cap W)(xRy)
			\end{gather*}

			\item G preserves the satisfiability of the non-contacts in $\beta$ if
			\begin{gather*}
				\neg C(e,f) \in \beta \rightarrow \neg ((\exists x \in \upsilon_n(e) \cap W)(\exists y \in \upsilon_n(f) \cap W)(xRy))
			\end{gather*}

			\item G preserves the satisfiability of the zero terms in $\beta$ if
			\begin{gather*}
				d = 0 \in \beta \rightarrow \upsilon(d) \cap W = \emptyset
			\end{gather*}

			\item G preserves the satisfiability of the non-zero terms in $\beta$ if
			\begin{gather*}
	...
	\begin{lemma}
		Let $\M^v = (\F^v, \upsilon_n)$ be a mode of $\beta$l. Let $G^v=(W^v, R^v)$ be the graph of $\F^v$. Let $G=(W,R) \subseteq G^v$. If G preserves the satisfiability of the contacts, non-contacts, zero terms and non-zero terms in $\beta$, then G defines a model $\M = (\F(W, R), \upsilon_n)$ of $\beta$.
	\end{lemma}
	...
	\end{defn}
		...
		Let $\M^v$ be a model of $\beta$. Let $G^v=(W^v, R^v)$ be the graph of $\F^v$. $G^v$ preserves the satisfiability of zero terms and non-contacts.
		All connected components of $G^v$ preserve the satisfiability of the zero terms and non-contacts in $\beta$. If there is a connected component $G'=(W', R')$ which satisfies the contacts and non-zero terms in $\beta$, then G' defines a connected model $\M'$ of $\beta$. Where $\F' = (W', R')$ and $\M' = (\F', \upsilon_n)$.
	...
	\begin{step}
		Each graph of $Comp^{G^v}$ satisfies the zero terms and non-contacts of $\beta$. They do not introduce new modal points netiher a connections. If $Comp^{G^v}$ contains a graph that satisfies the contacts and non-zero terms of $\beta$, then this graph defines a connected model of $\beta$. Otherwise, $\beta$ does not have a connected model.
	\end{step}
