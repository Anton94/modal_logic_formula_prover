...
% С табло методът строим двоично дърво, възлите на които са крайно множество от формули със знаци. Ще разбиваме тези формули със знаци докато не останат само атомарни фомрули, т.е. само променливи със знаци.
