...
\]
	...
	\subsection{Symbols Representation}
		...
		Let $t_1$, $t_2$ be terms, then the followings are representation of atomic formulae
		\begin{itemize}
		...
		\begin{itemize}
			...
			\item formulae, defined in the Formula Inductive Definition section \ref{sec:formula-inductive-definition}
		\end{itemize}
