...
\subsection{Measure formula satisfiability}
	...
	\paragraph{Valid model valuation}
	...
	\paragraph{Valid model relation}
	...
	\paragraph{1. Branch Conjunction} Using the tableau method iterate over each branch conjunction B.
