...
As of today, an algorithm that can solve this problem in a polynomial time is not possible. This is because the problem of constructing a satisfiable model for a quantitative contact formula is at least as hard as the Boolean satisfiability problem (SAT). That is why each optimization during the formula proving process significantly reduces the algorithm execution time.
